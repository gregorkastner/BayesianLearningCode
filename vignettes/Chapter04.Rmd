...
$$
We can plot this (not that base R does not ship the density function of the
inverse gamma, so we define it ourselves using the transformation law of
densities). Note that in R, the Gaussian distribution is parametrized in terms
of mean and standard deviation (not variance).
