...
```{r, echo = -c(1:2)}
if (pdfplots) {
  pdf("7-1_1.pdf", width = 12, height = 5)
...
(first order) stationarity of the returns. To check more formally, we fit AR(p)
models to both.
...
innovation variance, we assume an inverse gamma prior, and $\theta$ is assumed
to be a priori uniform on $[-1,1]$.
...
```{r, echo = -c(1:2), fig.width = 8, fig.height = 3}
if (pdfplots) {
  pdf("7-3_5.pdf", width = 8, height = 5)
}
...
We repeat the exercise above, but now use a truncated Gaussian proposal for
...
```{r, echo = -c(1:2), fig.width = 8, fig.height = 3}
if (pdfplots) {
  pdf("7-3_6.pdf", width = 8, height = 5)
}
par(mfcol = c(2, 3), mar = c(2.5, 2.5, 1.5, .1), mgp = c(1.5, .5, 0), lwd = 2)
for (i in seq_along(cthetas2)) {
...
```{r, echo = -c(1:2), fig.width = 8, fig.height = 3}
if (pdfplots) {
  pdf("7-3_7.pdf", width = 8, height = 5)
}
par(mfcol = c(2, 3), mar = c(2.5, 2.5, 1.5, .1), mgp = c(1.5, .5, 0), lwd = 2)
for (i in seq_along(cthetas3)) {
...
if (pdfplots) {
  ...
  par(mar = c(2.6, 2.6, 1.5, .1), mgp = c(1.5, .5, 0), lwd = 2)
}
par(mfrow = c(1, 2))
