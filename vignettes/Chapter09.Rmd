...
Section 9.1.4: Predictive analysis as a foundation for the Bayesian paradigm
...
```{r, echo = -c(1:2)}
if (pdfplots) {
  pdf("9-2_1.pdf", width = 8, height = 3.5)
  par(mar = c(2.6, 2.6, 1.5, .1), mgp = c(1.6, .6, 0))
}
par(mfrow = c(1, 2))
...
```{r, echo = -c(1:2)}
if (pdfplots) {
  pdf("9-2_2.pdf", width = 10, height = 4)
...
```{r, echo = -c(1:2)}
if (pdfplots) {
  pdf("9-2_3.pdf", width = 10, height = 4)
  par(mar = c(2.5, 2, 1.5, .5), mgp = c(1.6, .6, 0))
}
par(mfrow = c(1, 2))
...
```{r, echo = -c(1:2)}
if (pdfplots) {
  pdf("9-3_1.pdf", width = 8, height = 4)
  par(mar = c(1.5, 1.5, 1.5, .1), mgp = c(1.6, .6, 0))
}
par(mfrow = c(1, 1))
...
```{r, echo = -c(1:2)}
if (pdfplots) {
  pdf("9-4_2.pdf", width = 7, height = 2.5)
  par(mar = c(2.5, 2, 1.5, .5), mgp = c(1.6, .6, 0))
}
par(mfrow = c(1, 4))
horizon <- 8
...
```{r, echo = -c(1:2)}
if (pdfplots) {
  pdf("9-4_3.pdf", width = 10, height = 4)
...
```{r, echo = -c(1:2)}
if (pdfplots) {
  pdf("9-4_4.pdf", width = 10, height = 4)
  par(mar = c(2.5, 2.5, 1.5, .5), mgp = c(1.6, .6, 0))
}
...
```{r, echo = -c(1:2)}
if (pdfplots) {
  pdf("9-4_5.pdf", width = 6, height = 3.5)
  par(mar = c(2.5, 2, .1, .5), mgp = c(1.6, .6, 0))
}
...
```{r, echo = -c(1:2)}
if (pdfplots) {
  pdf("9-4_6.pdf", width = 9, height = 5.5)
