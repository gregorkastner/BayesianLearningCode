...
lines(x,  theta1_y_morepoints, lty = 3)
lines(x,  theta0_y_morepoints, lty = 3, col = "red")
```
...
```{r}
female_morepoints <- theta1_y_morepoints / (theta0_y_morepoints + theta1_y_morepoints)
male_morepoints <- theta0_y_morepoints / (theta0_y_morepoints + theta1_y_morepoints)
