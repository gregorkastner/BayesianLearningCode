...
```
TO DISCUSS: FIGURE 2.7 LOOKS SLIGHTLY DIFFERENT

For all our chosen priors, we get the same posterior mean, but we see slightly
...
rownames(res) <- paste0("a0 = ", a0, ", ", "b0 = ", round(b0))
res
```
