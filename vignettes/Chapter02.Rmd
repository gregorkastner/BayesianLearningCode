...
ts.plot(delta1, main = "Trace plot of delta1")
ts.plot(100*delta2, main = "Trace plot of delta2")
hist(delta1, breaks = 20, prob = TRUE, xlab = "", ylab = "")
hist(100*delta2, breaks = 20, prob = TRUE, xlab = "", ylab = "")
