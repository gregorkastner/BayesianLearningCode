...
We use tighter priors for the model parameters and a sample size of  N=50 observations.
...
Next we  change the order of the sampling steps to (c)-(b)-(a).
...
We see agenerally good fit but also notice some potential autocorrelation.
