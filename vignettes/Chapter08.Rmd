...
We start by visualising a latent  utility  for  a linear predictor  $\mathbf{x}\boldsymbol{\beta}$
with value of 1.  
...
With a tighter prior the autocorrelations are much lower and hence the estimated ESSs are higher and inefficiency is lower.
...
probit model $\beta$ to those of the logit model by multiplying them with
