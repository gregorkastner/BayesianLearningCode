...
$\mathcal{G}(2 , 0.5)$ for $\alpha$. We first run the full Gibbs sampler for
...
c_alpha <- 0.35
```
To check the correctness of the Gibbs sampler we focus on the overdispersion  $\frac{\mu_i^2}{\alpha}$ for $x_i=0$ and
