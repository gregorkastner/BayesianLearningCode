...
# fix tuning parameter for MH, M, and burnin
cnu <- 0.3
M <- 5000
burnin <- 1000
...
ts.plot(mus, xlab = "Draws", ylab = expression(mu))
ts.plot(sqrt(sigma2s), xlab = "Draws", ylab = expression(sigma))
ts.plot(nus, xlab = "Draws", ylab = expression(nu),
        main = paste0("Acceptance rate: ", round(100 * accepts / M), "%"))
selecta <- sample.int(N, 1)
ts.plot(ws[, selecta], xlab = "Draws", ylab = bquote(~omega[.(selecta)]))
```
