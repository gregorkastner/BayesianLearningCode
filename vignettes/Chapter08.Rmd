...
set.seed(1234)
X <- cbind(rep(1, N), x)
betas.sep <- probit(y, X, b0 = 0, B0 = 10000)
...
set.seed(1234)
X <- cbind(rep(1, N), x)
betas.qus1 <- probit(y, X, b0 = 0, B0 = 10000)
...
set.seed(1234)
X <- cbind(rep(1, N), x)
betas.qus2 <- probit(y, X, b0 = 0, B0 = 10000)
...
set.seed(1234)
betas.qus3 <- probit(y, X, b0 = 0, B0 = 2^2)

par(mfrow = c(2, 2), mar = c(2.5, 1.5, 1.5, .1), mgp = c(1.5, .5, 0), lwd = 1.5)

plot(betas.qus3[, 1], type = "l", main = "", xlab = "", ylab = "")
acf(betas.qus3[, 1])

plot(betas.qus3[, 2], type = "l", main = "", xlab = "", ylab = "")
acf(betas.qus3[, 2])

effectiveSize(betas.qus3)
```
