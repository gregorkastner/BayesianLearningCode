...
We next illustrate problems of the sampler when the response variable  contain either only few or very many successes. We use data with 1000 observations 
with 1 and 999 successes.
...
par(mfrow = c(2, ^1), mar = c(2.5, 1.5, 1.5, .1), mgp = c(1.5, .5, 0), lwd = 1.5)
