...
To  compute the parameters of the Normal proposal density we apply the Newton-Raphson estimator described in Section 8.2.1. We start with a vector of zeros and set the number of iterations to 30.
...
# determine the variance of the proposal
