...
We run the sampler for 1000 draws starting with a very large value for the
innovation variance. 
...
```
Even though the starting value of the error variance was far from the posterior distribution the  burn-in phase of the sampler is very short.
