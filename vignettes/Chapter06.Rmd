...
the covariates at their means. Hence the intercept is the  sales on the opening weekend box office for a film forecasted to be in the theaters with an average value weeks and an average value of screens. 
...
Next we define a function to compute the parameters of the  posterior of the regression effects under the improper prior  $p(\beta, \sigma^2) \propto \frac{1}{\sigma^2}$. 
