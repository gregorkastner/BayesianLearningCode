...
4-6 and 1-3 weeks before the film starts.
```{r}
...
Next we compute the parameters of the marginal posterior for the regression 
effects under the improper prior  $p(\beta, \sigma^2) \propto \frac{1}{\sigma^2}$.
```{r}
