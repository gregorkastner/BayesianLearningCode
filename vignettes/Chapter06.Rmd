...
```
# Exercise 6.3.
We now compute the predictions of  the box the  sales on the opening weekend box office for a film with  an average number of \emph{Screens} for a range of values for  \emph{Screens}.
```{r}
 nf<-35
...
Finally we compare the observed Box office sales and the predictions from our first Bayesian regression model.
```{r, echo = -c(1:3)}
if (pdfplots) {
