...
density ratio. Note, though, that this is a very poor approximation.

```{r}
# Estimate density
d <- density(psi, bw = "SJ", n = 2^20)

# Evaluate as close a possible to zero
dpost <- d$y[which.min(abs(d$x))]
