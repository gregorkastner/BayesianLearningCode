...
To predict the time series of children killed or seriously injured in
Linz use the functions defined for estimating a Poisson regression
model.
...
We reuse a function to determine mean and quantiles of the draws.
...
We see that the prediction interval is much too wide indicating that an
intervention effect is required.
